...
import { getData, postData, postFormDataApi } from "@services/apiAdminServer"
...
const CreateMovie = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await getData("movies/create");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log("End of FormData contents", movieFormData);

            const response = await postFormDataApi("movies", movieFormData, {
                headers: {
            ...
            alert("Có lỗi xảy ra khi tạo phim: " + (error.response?.data?.message || error.message));
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Thêm Phim Mới</h2>
                <button
                        ...
                        <div>
                            ...
                            <div className="mb-4">
                                ...
                                <p className="text-xs text-gray-500 mt-1">
                                    Slug sẽ được tự động tạo từ tên phim, bạn có thể chỉnh sửa nếu muốn
                                </p>
                            </div>
                    ...
                    <div className="mt-8 flex justify-end">
                        ...
                        >
                            {loading ? (
                                ...
                                <>
                                    <FaSave className="mr-2" /> Lưu phim
                                </>
                            )}
                        </button>
                    </div>
